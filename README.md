...
2. Install packages
   ...
   npm install
   ```
3. Ensure tests can be run. The test suite should fail initially, and the test suite runs both the lint and test commands.
   ```bash
   npm test
   ```
4. Use the following commands to test individual files and code correctness.
   ```bash
   # lint the code
   npm run lint
...
* Create a .zip version of this repository for submission to Canvas.
